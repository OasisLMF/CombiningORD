...
# %% test loading occurrence.bin max periods

f_path = Path("/home/vinulw/code/OasisPiWind/tests/combine-ord/full/runs/losses-20251127154921/input/occurrence.bin")

from oasislmf.pytools.common.input_files import read_occurrence

_, _, _, no_of_periods = read_occurrence(f_path.parent, f_path.name)
